...
//			the Business Plan (not the trial), and inputs a variety
//			of credit card numbers.  It verifies that the appropriate
//			classes are added (and thus which images are displayed)
//			for each brand of credit card.
//   Usage	:
//         casperjs --auto-exit=no [--engine=slimerjs] test cardDetectionTest.js \
//            --user=<username> --pass=<password>
////////////////////////////////////////////////////////////////////////////////
var fs = require('fs');

casper.test.begin('CC Input Test', function suite(test) {
